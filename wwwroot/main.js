...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('http://localhost:5000/product/getAllProduct').subscribe(function (result) {
            _this.list = result;
            console.log(result);
        });
    };
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.sayHello = function () {
        return this._http.get(this.greetUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
...
var ValueComponent = /** @class */ (function () {
    ...
    ValueComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('http://localhost:5000/api/values').subscribe(function (result) {
            _this.values = result;
            console.log(result);
        });
    };
...
module.exports = __webpack_require__(/*! C:\Users\aljooker\Desktop\dating app\src\main.ts */"./src/main.ts");
